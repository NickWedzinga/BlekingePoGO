...
# weather constants
UNKNOWN_WEATHERS = ["Hot", "Cold"]
SUNNY_WEATHERS = ["Sunny", "Mostly Sunny"]
PARTLY_CLOUDY_WEATHERS = ["Partly Sunny", "Intermittent Clouds", "Partly Sunny w/ Showers",
                          "Partly Sunny w/ T-Storms", "Partly Cloudy", "Partly Sunny w/ Flurries"]
CLOUDY_WEATHERS = ["Hazy Sunshine", "Mostly Cloudy", "Cloudy", "Dreary (Overcast)", "Mostly Cloudy w/ Showers",
                   "Mostly Cloudy w/ T-Storms", "Hazy Moonlight", "Mostly Cloudy w/ Flurries", "Mostly Cloudy w/ Snow"]
FOGGY_WEATHERS = ["Fog"]
RAINY_WEATHERS = ["Showers", "T-Storms", "Rain", "Sleet", "Freezing Rain"]
SNOWY_WEATHERS = ["Flurries", "Snow", "Ice", "Rain and Snow"]
CLEAR_WEATHERS = ["Clear", "Mostly Clear"]
WINDYABLE_WEATHERS = ["Sunny", "Mostly Sunny", "Partly Sunny", "Intermittent Clouds", "Hazy Sunshine", "Mostly Cloudy",
                      "Cloudy", "Dreary (Overcast)", "Windy", "Clear", "Mostly Clear", "Partly Cloudy",
                      "Intermittent Clouds", "Hazy Moonlight", "Mostly Cloudy"]
