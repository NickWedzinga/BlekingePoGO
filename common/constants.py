...
COMMAND_EXTENSIONS = [
    'utils.global_error_manager', 'testing.integration.integration_manager', 'sneaselcommands.leaderboards.support',
    'sneaselcommands.configure', 'sneaselcommands.dex',
...
MEDAL_ICON_URLS = {
    ...
    "totalxp": "4/47/City_Spotlight_medal.png",
